        ...
        <div className="hidden items-center gap-3 lg:flex w-[20%] justify-end">
          ...
          {!isAuthenticated && (
            <>
              ...
              <Link
                href="/auth"
                className="group relative flex items-center gap-2 overflow-hidden rounded-lg bg-white px-5 py-2.5 text-sm font-bold text-[#0B3D2E] shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105"
              >
          ...
          <div className="relative">
            ...
            >
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-sm font-bold text-[#0B3D2E]">
